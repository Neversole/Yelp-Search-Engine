...
class milestone1(QMainWindow):
    ...
    # Loads a list of states names into the combo box from the PostgreSQL business table
    ...
    # Load list of city names applicable to the selected state in the state combo box
    ...
    # Load list of zip codes applicable to the selected city in the city combo box
    ...
    # Load business information applicable to the selected zip code
    ...
    # Load the number of business located in the selected zip code
    ...
    # Load the population count of the selected zip code
    ...
    # Load average income for the selected zip code
